...
/**
 * This class is used to allocate resources according to Page Rank (Original) with in and out degree nodes
 */
public class PageRank_JGraphT_WithNeighborsMain {
    public static void main(String[] args) {
        ...
        var pageRank = new PageRank_JGraphT(AdjMat, assetLossVector);
