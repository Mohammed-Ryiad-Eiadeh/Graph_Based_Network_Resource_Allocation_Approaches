...
public class GraphData {
        ...
        try (Scanner resource = new Scanner(new File(String.valueOf(graphId.getPath())))) {
            ...
            while (resource.hasNext()) {
                ...
                switch (twoVertex.length) {
                    case 2 -> defenders[Integer.parseInt(twoVertex[0]) - 1][Integer.parseInt(twoVertex[1]) - 1] = new Defenders(1);
                    case 3 -> defenders[Integer.parseInt(twoVertex[0]) - 1][Integer.parseInt(twoVertex[1]) - 1] = new Defenders(Double.parseDouble(twoVertex[2]));
                }
            }
    ...
    public double[] getNodeAssetsLossValues() {
        return switch (graphId) {
            ...
            case Figure3 ->                      new double[] {0, 0, 25, 10, 55, 10}; // This is the example we clarify in this research (refere to Figure 3)
        };
    }
