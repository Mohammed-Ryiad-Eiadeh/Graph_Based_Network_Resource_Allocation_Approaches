...
import GraphAnalysisAndDefense.org.PageRank_JGraphT;

import java.util.Collection;

/**
 * This class is used to allocate resourcess according to Page Rank (Original) with in and out degree nodes
 */
public class PageRank_JGraphT_WithNeighborsMain {
    public static void main(String[] args) {
        ...
        var PRMB = new PageRank_JGraphT(AdjMat, assetLossVector);
        ...
        var FLDN = new AdjacentNodes(AdjMat, assetLossVector);
