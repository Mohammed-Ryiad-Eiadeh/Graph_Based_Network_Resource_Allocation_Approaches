package MainPackage.org.MainOfOurPageRank.org;
...
import RankingAlgorithms.org.PageRank;
...
public class PageRankWithInDegreeMain {
    public static void main(String[] args) {
        System.out.println("The performance of Page Rank and In-Degree Nodes ----------");
        ...
        var pageRank = new PageRank(AdjMat,
                assetLossVec,
                100,
                PageRank.PR_DenominatorType.numOfOutEdges);
        var scores = pageRank.getScores();
        ...
        var rankOfEachIteration = pageRank.getRankOfEachIteration();
