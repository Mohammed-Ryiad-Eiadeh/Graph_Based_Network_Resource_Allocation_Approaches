...
/**
 * This class is used to allocate resourcess according to Page Rank (Original) with in degree nodes
 */
public class PageRankV1WithInDegreeMain {
    public static void main(String[] args) {
        ...
        var PRMB = new PageRankV1(AdjMat, assetLossVec);
        ...
        for (var assetNode : nodes.keySet()) {
            ...
            for (var nod : parents) {
                    ...
                    var currentAssetCutOfTotalBudget = budget * scores.get(assetNode - 1) / sizeOfparents;
